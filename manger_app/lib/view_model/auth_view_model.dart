...
import 'package:manger_app/core/service/firestore_manger.dart';


import '../model/manger_model.dart';
import '../view/appointments/appointments_screen.dart';
...
print(verificationId);
  ...
  void saveUser(UserCredential userCredential) async{
    await FireStoreManger().addMangerToFireStore(MangerModel(
      mangerId :userCredential.user!.uid,
      name: name,
  ...
  void saveUserA(AuthCredential userCredential1) async{
    ...
    await FireStoreManger().addMangerToFireStore(MangerModel(
      mangerId :_auth.currentUser!.uid,
      name: name,
      phoneNumber: phoneNumber,
    )
    );
