...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.moyasar_payment.MoyasarPaymentPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin moyasar_payment, com.example.moyasar_payment.MoyasarPaymentPlugin", e);
    }
    try {
